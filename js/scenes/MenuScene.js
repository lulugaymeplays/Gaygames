export class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(width / 2, 100, 'SLINGSHOT MAYHEM', {
            font: '64px Orbitron', fill: '#ff3e00', stroke: '#000', strokeThickness: 6
        }).setOrigin(0.5);
        ...
        const countText = this.add.text(width / 2, 260, this.game.settings.playerCount, {
            font: '32px Orbitron', fill: '#ffffff'
        }).setOrigin(0.5);
    ...
    createButton(x, y, label, callback) {
        ...
        const bg = this.add.rectangle(0, 0, 240, 60, 0xff3e00).setInteractive({ useHandCursor: true });
